  ...
  return (
    <div className="fixed inset-x-4 bottom-4 z-50 mx-auto max-w-3xl rounded-3xl border border-[var(--border)] bg-white p-5 shadow-2xl shadow-black/10">
      <div className="grid gap-4 sm:grid-cols-[1fr_auto] sm:items-center">
        <div>
          <p className="font-semibold text-[var(--text-main)]">Google Analytics cookies</p>
          <p className="mt-1 text-sm leading-6 text-[var(--text-muted)]">
            We can use Google Analytics cookies to understand how people move through the configurator. No names, emails, phone numbers or private notes are sent.
          </p>
        </div>
