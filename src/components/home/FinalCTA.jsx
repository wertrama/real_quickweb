    ...
    <section className="px-4 pb-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-[var(--text-main)] p-8 text-white shadow-2xl shadow-black/20 sm:p-12">
        <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <button onClick={onStart} className="inline-flex items-center justify-center gap-2 rounded-full bg-[var(--cta)] px-6 py-4 font-semibold text-white shadow-lg shadow-black/20 transition hover:bg-[var(--cta-dark)]">
