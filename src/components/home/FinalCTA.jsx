      ...
      <div className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-zinc-950 p-8 text-white shadow-2xl shadow-zinc-950/20 sm:p-12">
        <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            ...
            <h2 className="max-w-3xl text-3xl font-black tracking-tight sm:text-5xl">Get a website plan and package before the build starts.</h2>
            <p className="mt-4 max-w-2xl leading-8 text-zinc-300">Choose a package or answer a few questions. Either way, the next step is clear.</p>
          </div>
